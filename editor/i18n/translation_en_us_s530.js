...
if(!ORYX.I18N.Smartdot) ORYX.I18N.Smartdot = {};
ORYX.I18N.Smartdot.processValidation = "Process check ";
ORYX.I18N.Smartdot.processProperties = "Process attribute";
ORYX.I18N.Smartdot.nodeProperties = "Node attribute";
ORYX.I18N.Smartdot.flowProperties = "Flow direction attribute";
ORYX.I18N.Smartdot.tmplProperties = "Component attribute";
ORYX.I18N.Smartdot.startNodeProperties = "Beginning node attribute ";
ORYX.I18N.Smartdot.endNodeProperties = "End node attribute ";
ORYX.I18N.Smartdot.saveMsg = "Saving...";
ORYX.I18N.Smartdot.okLabel = "Confirm";
ORYX.I18N.Smartdot.missingStartMsg = "Lack beginning node ";
ORYX.I18N.Smartdot.missingEndMsg = "Lack ending node";
ORYX.I18N.Smartdot.multipleStartMsg = "There are several beginning nodes";
ORYX.I18N.Smartdot.missingStartLineMsg = "Beginning node are not wired";
ORYX.I18N.Smartdot.multipleEndMsg = "There are several ending nodes";
ORYX.I18N.Smartdot.missingEndLineMsg = "Ending node are not wired";
ORYX.I18N.Smartdot.multipleTmplMsg = "There are several components";
ORYX.I18N.Smartdot.tooManyOtherConditionLineMsg = "There are too many other condition line";
ORYX.I18N.Smartdot.missingTmplLineMsg = "There are not wired components";
ORYX.I18N.Smartdot.tmplNoneMsg = "Component wiring only enters and goes out single";
ORYX.I18N.Smartdot.tmplNotConfigMsg = "There is unconfigured component";
ORYX.I18N.Smartdot.sequenceFlowMsg = "Wiring isn't connected";
ORYX.I18N.Smartdot.multipleLineMsg = "Wiring repeats";
ORYX.I18N.Smartdot.taskNoneMsg = "There is unwired node";
ORYX.I18N.Smartdot.taskNotConfigMsg = "There is no unconfigured node";
ORYX.I18N.Smartdot.taskHasNotDealMsg = "There is no handlers node";
ORYX.I18N.Smartdot.validationResultsMsg = "Verifying result";
ORYX.I18N.Smartdot.successMsg = "Verification pass";
ORYX.I18N.Smartdot.flowChangedMsg = "After process is changed, the file using the flow will be affected! Whether to continue?";
ORYX.I18N.Smartdot.saveErrorMsg = "Saving flow erroe";
ORYX.I18N.Smartdot.savesuccessMsg = "Successfully save!";
ORYX.I18N.Smartdot.alert = "Prompt";
ORYX.I18N.Smartdot.gaizhang = "Seal";
ORYX.I18N.Smartdot.taoda = "Fill template";
ORYX.I18N.Smartdot.bianhao = "Code";
ORYX.I18N.Smartdot.huiqian = "Countersign";
//2014-07-21 为新增的功能增加本地化 HMS
ORYX.I18N.Smartdot.notConnectedForSplit = "There is unwired split gateway";
ORYX.I18N.Smartdot.notConfiguredForSplit = "There is unconfigured split gateway ";
ORYX.I18N.Smartdot.theOnlyOneLineForMerger = "There is only one wire after gateway merges";
ORYX.I18N.Smartdot.notConnectedForMerger = "There is unwired merge gateway";
ORYX.I18N.Smartdot.notConfiguredForMerger = "There is unconfigured merge gatewayateway";
ORYX.I18N.Smartdot.theOnlyOneLineForTrigger = "There is only one wire after triggering process ";
ORYX.I18N.Smartdot.notConnectedForTrigger = "There is unwired trigger process";
ORYX.I18N.Smartdot.notConfiguredForTrigger = "There is unconfigured trigger process";
ORYX.I18N.Smartdot.splitAndMergeDoesNotMatch = "Split gateway and merge gateway don’t match ";
ORYX.I18N.Smartdot.conditioncombo = "Condition gateway appears infinite loop";
ORYX.I18N.Smartdot.triggerProcessProperties = "Trigger process attribute ";
ORYX.I18N.Smartdot.splitProperties = "Split attribute";
ORYX.I18N.Smartdot.mergeProperties = "Merge attribute";
ORYX.I18N.Smartdot.saveAgtError = "Saving of agent goes wrong!";
ORYX.I18N.Smartdot.btnOk = "Confirm";
...
ORYX.I18N.Oryx.notLoggedOn = "Not logged in";
...
ORYX.I18N.Arrangement.amDesc = "Horizontal align center ";
...
ORYX.I18N.Edit.delDesc = "Delete the selected graph ";
...
ORYX.I18N.Save.saveDesc = "Save flow chart ";
ORYX.I18N.Save.saveAs = "Save as ...";
ORYX.I18N.Save.saveAsDesc = "Save as ...";
ORYX.I18N.Save.unsavedData = "Process has been amended, save data before leaving, or the amended data will lose!";
ORYX.I18N.Save.newProcess = "New flow chart";
ORYX.I18N.Save.saveAsTitle = "Save as...";
ORYX.I18N.Save.saveBtn = "Save";
ORYX.I18N.Save.close = "Close";
ORYX.I18N.Save.savedAs = "Saved As";
ORYX.I18N.Save.saved = "Successfully save!";
...
ORYX.I18N.File.printDesc = "Print the current flowchart ";
ORYX.I18N.File.pdf = "Exported as PDF";
ORYX.I18N.File.pdfDesc = "Exported as PDF";
...
ORYX.I18N.PropertyWindow.name = "Attribute name ";
...
if(!ORYX.I18N.PoolLaneHandling) ORYX.I18N.PoolLaneHandling = {};

ORYX.I18N.PoolLaneHandling.description = "Pools and Lanes represent responsibilities for activities in a process. Pools represent whole organization units, lanes subdivide pools or other lanes hierarchically.";
//ORYX.I18N.PoolLaneHandling.group = "Swimlanes";
//ORYX.I18N.PoolLaneHandling.poolLane = "Pool/Lane";
//shanglihui 20111212
ORYX.I18N.PoolLaneHandling.group = "Lane";
ORYX.I18N.PoolLaneHandling.poolLane = "Pool/lane";

ORYX.I18N.PoolLaneHandling.insertLane = "Insert Lane {0}";
ORYX.I18N.PoolLaneHandling.createPool = "Create new Pool";
ORYX.I18N.PoolLaneHandling.createSublane = "Insert Sublane";
ORYX.I18N.PoolLaneHandling.cannotCreateRole = "A new Lane cannot be created\nat this position.";
ORYX.I18N.PoolLaneHandling.above = "Above";
ORYX.I18N.PoolLaneHandling.below = "Below";
ORYX.I18N.PoolLaneHandling.left = "Left";
ORYX.I18N.PoolLaneHandling.right = "Right";

ORYX.I18N.PoolLaneHandling.buttonSwitch = "Switch with adjacent Lane";
ORYX.I18N.PoolLaneHandling.buttonIndent = "Move into adjacent Lane";
ORYX.I18N.PoolLaneHandling.buttonOutdent = "Move one tier up in the hierarchy";
...
ORYX.I18N.SyntaxChecker.desc = "Syntax check";
ORYX.I18N.SyntaxChecker.noErrors = "There is no syntax error.";
...
ORYX.I18N.Undo.undoDesc = "Undo";
ORYX.I18N.Undo.redo = "Redo";
ORYX.I18N.Undo.redoDesc = "Redo";
...
ORYX.I18N.View.zoomStandardDesc = "Zoom Standard";
ORYX.I18N.View.zoomFitToModel = "Zoom fit to model";
ORYX.I18N.View.zoomFitToModelDesc = "Zoom fit to model";
...
ORYX.I18N.PropertyWindow.title = "Attribute";

if(!ORYX.I18N.ShapeRepository) ORYX.I18N.ShapeRepository = {};
ORYX.I18N.ShapeRepository.title = "Pel base";
...
if(!ORYX.I18N.PropertyWindow.Richtext) ORYX.I18N.PropertyWindow.Richtext = {};

ORYX.I18N.PropertyWindow.Richtext.simpleEditingModeTitle = "Simple Editing Mode";
ORYX.I18N.PropertyWindow.Richtext.simpleEditingModeDesc = "Switch to simple Editing mode";
ORYX.I18N.PropertyWindow.Richtext.simpleEditingModeWarning = "Advanced formating options are not available in the simple Editing mode. If you continue, all existing formating options can be lost.";
ORYX.I18N.PropertyWindow.Richtext.notAvailableTitle = "Advanced formating not available";
ORYX.I18N.PropertyWindow.Richtext.notAvailableWarning = "The advanced Editing mode is not supported by your browser.<br/>If you continue, all existing formating options can be lost.";
